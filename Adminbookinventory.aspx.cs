...
namespace WebApplication1
{
    public partial class Adminbookinventory : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            if(checkIfBookExist())
            {
                Response.Write("<script>alert('Books Already Exists.Try some other book Id.')</script>");
            }
            else
            {
                addNewBook();
        ...
        void getBooksById()
        {
            try
            {
                ...
                if(dt.Rows.Count>=1)
                {
                    ...
                    TextBox14.Text = dt.Rows[0]["book_description"].ToString();
        ...
        void addNewBook()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO book_master_tbl(book_id,book_name,genre,author_name,publisher_name,publisher_date,language,"+
